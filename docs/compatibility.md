...
remains 0.11.0 until all 0.12 gates pass.
...
and confirms governed qualification is the safe default. The artifact remains 0.11.0.
...
rebuild. The artifact remains 0.11.0.
