...
- primary stable Agno 3.0.6 during development and the newest certified stable at RC;
...
- Agno 2.6.4, 2.9.0, and 3.0.6 full compatibility lanes.
...
- Agno 2.6.4 legacy, stable-v2 2.9.0, primary 3.0.6, and current MCP;
